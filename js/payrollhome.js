...
const createInnerHtml=()=>
{
    ...
    for(const empPayrollData of empPayrollList){
        ...
        <tr>
            ...
            <td><img id="${empPayrollData.id}" onclick= "remove(this)" alt="delete" src="../profilePic/delete-black-18dp.svg">
            <img id="${empPayrollData.id}" onclick= "update(this)" alt="edit" src="../profilePic/create-black-18dp.svg"></td>
        </tr>`;
    }
